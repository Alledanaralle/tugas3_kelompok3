...
```
Mengambil semua kelas workout beserta data trainer terkait menggunakan JOIN SQL dan mengembalikan data dalam format array asosiatif.
```php
public function getAllTrainers()
{
...
```
Script diatas berfungsi untuk mengambil data semua trainer dari tabel trainer.
```php
...
```
Script diatas berfungsi untuk menghitung total anggota dari tabel member.
```php
...
```
Script diatas merupakan script untuk menghitung jumlah total trainer.
```php
...
```
Script diatas berfungsi untuk menghitung total kelas.
```php
...
```
Script diatas berfungsi untuk menghitung jumlah total alat GYM.
```php
...
```
Script diatas mengambil 5 kelas terpopuler berdasarkan kuota tertinggi, diurutkan secara descending.
```php
...
```
Script diatas berfungsi untuk mengambil informasi alat termasuk nama, jenis, dan kondisinya.
```php
...
```
Script diatas berfungsi mengambil anggota terbaru berdasarkan ID secara descending dengan batas jumlah yang ditentukan oleh parameter $limit.
```php
public function find($id)
{
...
```
Berfungsi untuk mencari data kelas workout berdasarkan id_class.
```php
...
```
Script ini berfungsi  untuk menambahkan data kelas baru ke tabel workout_classes.
```php
...
```
Script diatas berfungsi untuk memperbarui data kelas berdasarkan id_class.
```php
...
```
<h3>Full Script Controller Workout Class </h3>
