...
class TrainerController
{
    ...
    public function store()
    {
        ...
        header('Location: /trainer/index'); // Mengarahkan kembali ke halaman daftar trainer
    }
    ...
    public function update($id)
    {
        ...
        if ($updated) {
            header("Location: /trainer/index"); // Mengarahkan kembali ke halaman daftar trainer jika berhasil
        } else {
